...
### :bookmark_tabs: **Rotas**
As rotas utilizadas no insomnia estão todas disponiveis no arquivo <a href="https://github.com/GustavoBlaze/fastfeet/blob/master/Insomnia.json" target="_blank" alt="Rotas">Insomnia.json</a>
